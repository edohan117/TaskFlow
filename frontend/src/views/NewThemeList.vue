<template>
  <section class="room-list">
    <h2 class="section-title">New Theme</h2>
    <div class="room-grid">
      <router-link v-for="room in paginatedRooms" :key="room.ID" :to="{ name: 'RoomDetail', params: { id: room.ID } }" class="room-card-link">
        <article class="room-card">
          ...
          <div class="room-info">
            ...
            <P><i class="bi bi-balloon-heart"></i> {{ room.LIKES }}</P>
            ...
            <div class="room-meta">
              ...
              <span class="meta-item"><i class="fas fa-clock"></i> 평점 {{ room.RATING }}</span>
            </div>
          </div>
        </article>
      </router-link>
